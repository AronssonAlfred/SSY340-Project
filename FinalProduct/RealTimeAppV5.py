...
emotion_model = EmotionDetectionModel2(48, 8)
checkpoint_path = 'Emotion classification/CKP_model_2.ckpt'  # Path to the trained emotion detection model checkpoint
    ...
    while True:
        ...
        for result in results:
            for box in result.boxes:
                ...
                train_mean = torch.tensor([0.5047])
                train_std = torch.tensor([0.2930])
